// Runtime types generated with workerd@1.20241011.1 2023-10-01 
/*! *****************************************************************************
...
declare module "cloudflare:workers" {
    ...
    export type WorkflowStep = {
        do: (<T extends Rpc.Serializable>(name: string, callback: () => Promise<T>) => Promise<T>) | (<T extends Rpc.Serializable>(name: string, config: WorkflowStepConfig, callback: () => Promise<T>) => Promise<T>) | (<T extends Rpc.Serializable>(name: string, config: WorkflowStepConfig | (() => Promise<T>), callback?: () => Promise<T>) => Promise<T>);
        sleep: (name: string, duration: WorkflowSleepDuration) => Promise<void>;
        sleepUntil: (name: string, timestamp: Date | number) => Promise<void>;
    };
    export abstract class WorkflowEntrypoint<Env = unknown, T extends Rpc.Serializable | unknown = unknown> implements Rpc.WorkflowEntrypointBranded {
