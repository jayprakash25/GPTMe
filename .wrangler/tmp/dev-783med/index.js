...
// .wrangler/tmp/bundle-9h0BYF/checked-fetch.js
...
// .wrangler/tmp/bundle-9h0BYF/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-9h0BYF/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
init_checked_fetch();
init_modules_watch_stub();
var systemPrompt = `You are an AI assistant tasked with creating a personalized digital twin of the user through natural conversation. Your goal is to understand and replicate their unique communication style, personality, and knowledge base.
...
async function processMessage(db, ai, userId, message) {
  try {
    ...
    if (conversation.status === "completed") {
      ...
      if (aiResponse.toLowerCase().includes("your digital version is created now")) {
