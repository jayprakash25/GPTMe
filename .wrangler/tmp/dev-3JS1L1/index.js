...
// .wrangler/tmp/bundle-xQC0iZ/checked-fetch.js
...
// .wrangler/tmp/bundle-xQC0iZ/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-xQC0iZ/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
async function processMessage(db, ai, userId, message) {
  try {
    ...
    if (conversation.status === "completed") {
      ...
      if (aiResponse.toLowerCase().includes("your digital version is now created")) {
